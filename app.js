...
var minutes = currentDateTime.getTime() / 1000 / 60;
console.log("Elapsed minutes since january 1, 1970:" + " " + minutes);


// Question No:7
var currentDateTime = new Date();
var time = currentDateTime.getHours();
if(time < 12)
{
    console.log("It's time to AM")
}
else
{
    console.log("It's time to PM");
}


// Question No:8
var laterDate = new Date("31 Dec, 2020");
console.log("The last day of the last month:" + " " + laterDate);
...
var totalDays = (Math.ceil((currentDateTime.getTime() - ramadanDate.getTime()) / (oneDay)));
console.log(totalDays + " " + "days has passed since 1st Ramadan, 2015:");


// Question No:10
var currentDateTime = new Date();
var diff1 = currentDateTime.getTime();
var exactDateTime = new Date("5 Dec 2015 22:50:16 GMT");
var diff2 = exactDateTime.getTime();
var diffTime = diff1 - diff2;
console.log("On reference date:" + " " + exactDateTime);
var seconds = diffTime / 1000;
console.log(seconds + " " + "seconds had passed since endind of year, 2015:");
...
console.log("1 hours age, it was:" + " " + currentDateTime);

////var currentDateTime = new Date();
//var currentHour = currentDateTime.getHours()-1;
//console.log("1 hours age, it was date:" + " " + currentHour);


// Question No:12
var currentDateTime = new Date("5 Dec 2015 23:09:37 GMT");
console.log("Current date:" + " " + currentDateTime);
currentDateTime.setYear( currentDateTime.getYear() - 100);
console.log("100 years back, it was:" + " " + currentDateTime);


// Question No:13
var dateOfBirth = new Date(prompt("Enter your date of birth:", "Jan 1, 1970"));
var miliSecond = dateOfBirth.getTime();
var currentDateTime = new Date();
var currentMiliSecond = currentDateTime.getTime();
